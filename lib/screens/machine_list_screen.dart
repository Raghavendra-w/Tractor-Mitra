...
class MachineListScreen extends StatefulWidget {
  ...
  const MachineListScreen({super.key, required this.category});
...
class _MachineListScreenState extends State<MachineListScreen> {
  ...
  Widget _buildImage(String? image) {
    ...
    return Image.network(
      "http://localhost:8000$image", // ✅ IMPORTANT for Flutter Web
      fit: BoxFit.cover,
                ...
                return GestureDetector(
                  onTap: () async {
                    final result = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => TractorDetailsScreen(tractor: machine),
                      ),
                    );
                      ...
                      children: [
                        Expanded(
                          child: ClipRRect(
                            ...
                            child: _buildImage(machine['image']),
                          ),
                        ),
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("₹${machine['price_per_hour']} / hr"),
